...
layui.use(['table', 'laydate'], function () {
    ...
    tableIns = table.render({
        ...
        , cols: [[ //表头
            ...
            { field: 'oid', title: '订单号', sort: true, totalRowText: '合计' }
    ...
    //工具栏事件
    table.on('toolbar(storage_output)', function (obj) {
            ...
            case 'add':
                layer.open({
                    ...
                    success: function (layero, index) {
                        ...
                        //初始化表单数据的值
                        body.find("#edit-table").val('output');
                    }
                });
                layer.msg('添加');
                break;
    ...
    table.on('row(storage_output)', function (obj) {
        console.log(obj);
        //layer.closeAll('tips');
    });
    ...
    //监听表格复选框选择
    table.on('checkbox(storage_output)', function (obj) {
        console.log(obj)
    });

    //监听表格单选框选择
    table.on('radio(storage_output)', function (obj) {
        console.log(obj)
    });

    //监听表格单选 框选择
    table.on('rowDouble(storage_output)', function (obj) {
        console.log(obj);
    });

    //监听单元格编辑
    table.on('edit(storage_output)', function (obj) {
    ...
    //监听行工具事件
    table.on('tool(storage_output)', function (obj) {
        var data = obj.data;
        //console.log(obj)
        switch (obj.event) {
            case 'edit':
